...
import com.biology.commons.annotation.RateLimiter;
...
import com.biology.commons.utils.ServletUtils;
    ...
    public void doBefore(JoinPoint point, RateLimiter rateLimiter) throws Throwable {
        ...
        try {
            ...
            if (StringUtils.isNull(number) || number.intValue() > count) {
                throw new SysException(ResultCodeEnum.FAIL.code(), "访问过于频繁，请稍候再试");
            }
            log.info("限制请求'{}',当前请求'{}',缓存key'{}'", count, number.intValue(), key);
        } catch (Exception e) {
            throw new SysException(ResultCodeEnum.FAIL.code(), "服务器限流异常，请稍候再试");
        }
    }

...
public class MinIoUtils {
    ...
    public String createUploadUrl(String bucketName, String objectName) {
        return createUploadUrl(bucketName, objectName, expiry);
    }
     ...
     * @Description 文件上传
     */
    public MinIoUploadVo upload(MultipartFile multipartFile, String bucketName, String directory) {
        ...
        try {
            ...
            directory = Optional.ofNullable(directory).orElse(SEPARATOR_STR);
            minFileName = (directory.equals(SEPARATOR_STR) ? directory : (directory + Constants.SLANT)) + minFileName(Objects.requireNonNull(multipartFile.getOriginalFilename()));
            //上传文件到指定目录
            ...
            throw new SysException(ResultCodeEnum.FAIL.code(), "文件上传失败！" + e.getMessage());
        } finally {
            try {
        ...
        return MinIoUploadVo.builder()
                ...
                .minFileUrl(getObjectUrl(bucketName, minFileName, expiry))
                .build();
    }
    ...
    public void download(HttpServletResponse response, String bucketName, String minFileName) {
        ...
        try {
            ...
            throw new SysException(ResultCodeEnum.FAIL.code(), "下载失败！" + e.getMessage());
        } finally {
            //关闭流
            try {
    ...
    public String createUploadChunkUrl(String bucketName, String objectMD5, Integer partNumber) {
        ...
        objectMD5 += Constants.SLANT + partNumber + ".chunk";
    ...
    public Map<Integer, String> mapChunkObjectNames(String bucketName, String ObjectMd5) {
        ...
        for (String chunkName : chunkPaths) {
            Integer partNumber = Integer.parseInt(chunkName.substring(chunkName.indexOf(Constants.SLANT) + 1, chunkName.lastIndexOf(".")));
    ...
    static class Str2IntComparator implements Comparator<String> {
        ...
        public int compare(String arg0, String arg1) {
            Integer intArg0 = Integer.parseInt(arg0.substring(arg0.indexOf(Constants.SLANT) + 1, arg0.lastIndexOf(".")));
            Integer intArg1 = Integer.parseInt(arg1.substring(arg1.indexOf(Constants.SLANT) + 1, arg1.lastIndexOf(".")));
            if (reverseOrder) {
